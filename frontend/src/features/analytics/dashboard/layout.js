 ...
 * Единая четырёхколоночная сетка: s — 1 колонка, m — 2 колонки, l — 3 колонки.
 * Плитки занимают один ряд, графики — два: рядом с большим графиком помещаются две маленькие плитки.
 */
