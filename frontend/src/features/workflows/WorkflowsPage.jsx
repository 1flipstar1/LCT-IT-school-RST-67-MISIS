...
export function WorkflowsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Этапы работы" hint="Шаги, через которые проходит работа с каждым вузом: от поиска контактов до контроля. Здесь меняют названия, порядок и сроки этапов. Для другой аудитории, например школ, можно завести отдельный набор этапов."
        actions={
