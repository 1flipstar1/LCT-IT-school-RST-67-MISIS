...
*/
var startingStyle$1 = "data-starting-style";
/**
* Present when the component is animating out.
*/
var endingStyle$1 = "data-ending-style";
//#endregion
//#region node_modules/@base-ui/react/internals/stateAttributesMapping.mjs
var STARTING_HOOK = { [startingStyle$1]: "" };
var ENDING_HOOK = { [endingStyle$1]: "" };
...
function useAnimationsFinished(elementOrRef, waitForStartingStyleRemoved = false, batch = false) {
	...
	return useStableCallback((fnToExecute, signal = null) => {
		...
		if (waitForStartingStyleRemoved) {
			const startingStyleAttribute = startingStyle$1;
...
//#endregion
export { findNonDisabledListIndex as $, useCompositeRootContext as $t, fastComponentRef as A, useRenderElement as An, webkit as At, FloatingTreeStore as B, escapeKey as Bt, useTriggerRegistration as C, pressableTriggerOpenStateMapping as Cn, getTarget as Ct, useSyncedFloatingRootContext as D, open as Dn, stopEvent as Dt, useTransitionStatus as E, endingStyle as En, isVirtualPointerEvent as Et, FloatingNode as F, warn as Fn, useBaseUiId as Ft, POPUP_COLLISION_AVOIDANCE as G, outsidePress as Gt, CLICK_TRIGGER_IDENTIFIER as H, imperativeAction as Ht, FloatingTree as I, useMergedRefs as In, useId as It, getNodeChildren as J, triggerHover as Jt, enqueueFocus as K, siblingOpen as Kt, useFloatingNodeId as L, useRefWithInit as Ln, createChangeEventDetails as Lt, useDismiss as M, EMPTY_ARRAY as Mn, Timeout as Mt, useClick as N, EMPTY_OBJECT as Nn, useTimeout as Nt, ReactStore as O, startingStyle as On, jsdom as Ot, FloatingFocusManager as P, NOOP as Pn, useOnMount as Pt, isOutsideEvent as Q, ownerDocument as Qt, useFloatingParentNodeId as R, cancelOpen as Rt, useTriggerDataForwarding as S, popupTransitionStateMapping as Sn, contains as St, useAnimationsFinished as T, closed as Tn, isVirtualClick as Tt, DISABLED_TRANSITIONS_STYLE as U, itemPress as Ut, FloatingPortal as V, focusOut as Vt, DROPDOWN_COLLISION_AVOIDANCE as W, listNavigation as Wt, getTabbableAfterElement as X, useButton as Xt, getNextTabbable as Y, triggerPress as Yt, getTabbableBeforeElement as Z, dispatchClickWithModifiers as Zt, useImplicitActiveTrigger as _, isOverflowElement as _n, ARROW_DOWN$1 as _t, InternalBackdrop as a, getContainingBlock as an, FocusGuard as at, usePopupRootStore as b, isWebKit as bn, ARROW_UP$1 as bt, usePopupHandleStore as c, getNodeName as cn, mergeCleanups as ct, PopupTriggerMap as d, getParentNode as dn, getFloatingFocusElement as dt, useIsoLayoutEffect as en, getMaxListIndex as et, FOCUSABLE_POPUP_PROPS as f, getWindow as fn, isInteractiveElement as ft, createPopupOpenState as g, isLastTraversableNode as gn, matchesFocusVisible as gt, createDefaultInitialFocus as h, isHTMLElement as hn, isTypeableElement as ht, useScrollLock as i, getComputedStyle$1 as in, isListIndexDisabled as it, BasePopupHandle as j, mergeProps as jn, mac as jt, fastComponent as k, transitionStatusMapping as kn, voiceOver as kt, createInitialPopupStoreState as l, getNodeScroll as ln, addEventListener as lt, attachPreventUnmountOnClose as m, isElement as mn, isTypeableCombobox as mt, useOpenMethodTriggerProps as n, useStableCallback as nn, isElementVisible as nt, inertValue as o, getDocumentElement as on, useAnimationFrame as ot, PopupHandleAttachment as p, isContainingBlock as pn, isTargetInsideEnabledTrigger as pt, createAttribute as q, triggerFocus as qt, NullStore as r, SafeReact as rn, isIndexOutOfListBounds as rt, COMPOSITE_KEYS as s, getFrameElement as sn, useValueAsRef as st, useOpenInteractionType as t, error as tn, getMinListIndex as tt, popupStoreSelectors as u, getOverflowAncestors as un, require_jsx_runtime as ut, useOpenStateTransitions as v, isTableElement as vn, ARROW_LEFT$1 as vt, useOpenChangeComplete as w, triggerOpenStateMapping as wn, isMouseLikePointerType as wt, usePopupRootSync as x, popupStateMapping as xn, activeElement as xt, usePopupInteractionProps as y, isTopLayer as yn, ARROW_RIGHT$1 as yt, useFloatingTree as z, closePress as zt };
